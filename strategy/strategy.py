...
class FedCustom(fl.server.strategy.FedAvg):
    def __init__(
        self, accuracy_gauge: Gauge = None, loss_gauge: Gauge = None, f1_gauge: Gauge = None, *args, **kwargs
    ):
    ...
    def aggregate_evaluate(
        ...
        metrics_aggregated = {"loss": loss_aggregated, "accuracy": accuracy_aggregated, "f1": f1_scores_aggregated}
